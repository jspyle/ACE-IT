    ...
    <div class="w3-row-padding" style="margin-top:64px">
        <div class="w3-quarter w3-section">
            <ul class="w3-ul w3-white w3-hover-shadow">
                ...
                <li class="image"><img src="../resources/Workstations/WS-2.webp"></li>
                <li class="w3-padding-16">
                    <p class="w3-wide">Whether it's simple CAD work, high performance business or high end 3D modeling we have workstations for any of your specialist needs </p>
                </li>
        ...
        <div class="w3-quarter w3-section">
            <ul class="w3-ul w3-white w3-hover-shadow">
                ...
                <li class="image"><img src="../resources/Servers/SERV-STORE.webp"></li>
                <li class="w3-padding-16">
                    <p class="w3-wide">Whether it's simple CAD work, high performance business or high end 3D modeling we have workstations for any of your specialist needs </p>
                </li>
                <li class="w3-light-grey w3-padding-24">
        ...
        <div class="w3-quarter w3-section">
            <ul class="w3-ul w3-white w3-hover-shadow">
                ...
                <li class="image"><img src="../resources/Routers/ROUTER-2.webp"></li>
                <li class="w3-padding-16">
                ...
                <li class="w3-light-grey w3-padding-24">
                    <button onclick="window.location.href = '#Rotuers';" class="w3-button w3-black w3-padding-large">GO TO</button>
                </li>
            </ul>
        </div>
        <div class="w3-quarter w3-section">
            <ul class="w3-ul w3-white w3-hover-shadow">
                ...
                <li class="image"><img src="../resources/pc1.webp"></li>
                <li class="w3-padding-16">
                    <p class="w3-wide">Whether it's simple CAD work, high performance business or high end 3D modeling we have workstations for any of your specialist needs </p>
                </li>
                <li class="w3-light-grey w3-padding-24">
    ...
    <div class="" style="margin-top:64px">
        <div class="w3-col w3-left" style="width:300px; padding:0">
            <ul class="w3-ul w3-white w3-hover-shadow" style="height: 400px">
                <li style="padding: 0"><img src="../resources/Workstations/WS-1.webp" width="100%"></li>
            </ul>
        </div>
